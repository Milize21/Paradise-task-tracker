...
export class BasePage extends ExtendedBasePage implements TBasePage {
  ...
  constructor(
    ...
    // `?? null` bukan `|| undefined`: halaman tingkat atas memang bernilai null,
    // dan membedakan "tidak punya induk" dari "belum dimuat" itu yang dipakai
    // pohon halaman untuk menentukan akar.
