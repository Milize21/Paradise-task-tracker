  ...
  return (
    <DefaultLayout>
      <div className="relative z-10 flex h-screen w-screen overflow-hidden">
        ...
        <img
          src={ParadiseLogo}
          className="pointer-events-none absolute -top-24 -left-32 h-56 w-96 object-contain opacity-10"
          alt=""
          aria-hidden="true"
        />
        <img
          src={ParadiseLogo}
          className="pointer-events-none absolute -right-20 -bottom-16 h-56 w-96 object-contain opacity-10"
          alt=""
          aria-hidden="true"
        />
        {/* Main content */}
        <div className="flex h-full w-full flex-col items-center px-8 pt-6 pb-10">
          ...
          <div className="flex h-full w-full flex-col items-center justify-center gap-7">
            <div className="flex flex-col items-center gap-11">
              <img src={ParadiseLogo} className="h-24 w-40 object-contain" alt="Paradise Perkasa Logo" />
              <div className="flex max-w-124 flex-col items-center gap-3">
                <h1 className="text-h2-semibold text-primary">Welcome to Paradise Task Tracker</h1>
