...
const TOUR_STEPS: {
...
}[] = [
  {
    ...
    description:
      "Work item adalah satuan kerja terkecil di Paradise Task Tracker. Hampir semua konsep lain bertaut dengan work item and their properties.",
    image: IssuesTour,
    nextStep: "cycles",
  },
  {
          ...
          <div className="h-full overflow-hidden">
            ...
            <div className="flex flex-col overflow-y-auto p-6">
              <h3 className="font-semibold sm:text-18">
                Selamat datang di Paradise Task Tracker, {currentUser?.first_name} {currentUser?.last_name}
              </h3>
              <p className="mt-3 text-13 text-secondary">
                We{"'"}re senang Anda bergabung. You can now manage your projects with ease. Get started by creating a
                project.
              </p>
