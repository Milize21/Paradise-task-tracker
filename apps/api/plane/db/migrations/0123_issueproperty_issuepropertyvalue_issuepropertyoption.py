    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('property_type', models.CharField(choices=[('TEXT', 'Teks'), ('DECIMAL', 'Angka'), ('BOOLEAN', 'Ya/Tidak'), ('DATETIME', 'Tanggal'), ('OPTION', 'Pilihan'), ('MEMBER', 'Anggota')], default='TEXT', max_length=20)),
