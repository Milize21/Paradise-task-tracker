    ...
    <>
      ...
      <div className="mt-10 flex w-full flex-grow flex-col items-center justify-center py-6">
        <div className="relative flex w-full max-w-[22.5rem] flex-col gap-6">
          <FormHeader
            heading="Kelola instance Paradise Task Tracker"
            subHeading="Atur setelan tingkat instance untuk mengamankannya"
          />
          <form
            className="space-y-4"
            method="POST"
          ...
          >
            ...
            <div className="w-full space-y-1">
              ...
              <Input
                ...
                autoComplete="off"
                // eslint-disable-next-line jsx-a11y/no-autofocus -- kolom pertama layar login; halaman ini tidak punya konten lain yang bisa terlewat
                autoFocus
              />
            </div>
